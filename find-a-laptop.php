...
<body>
    ...
    <a id="profile-btn" href="edit-profile.html" class="btn">
        <!--<?php echo $_SESSION["username"]?>-->Profile</a>
    <div class="menu-wrap">
...
<?php endif ?> -->
                                    ...
                                    <div class="search-box">
                                        <input class="form-contro l mr-sm-2 search-txt laptop-search-bar" type="seach"
