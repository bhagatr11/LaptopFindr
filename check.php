...
/*
$result=mysqli_query($conn, "SELECT favourites FROM user WHERE username='$userName'");
...
//$get_results= $fav->fetch_assoc();

if($get_results) {
    //make the new favourites available to favourites.js
    print_r($get_results); 
}
